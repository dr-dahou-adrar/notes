...
git branch -D <repo>            # Deletes the master branch
git branch -m <repo>            # Rename the current branch to master
git push -f origin <repo>       # Force push master branch to github
```
